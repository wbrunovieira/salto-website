...
import { slidesConteudo } from './slides/02-conteudo';
import { slidesFechamento } from './slides/03-fechamento';
import OSInlineWebsite from './OSInlineWebsite';
...
<div style="width:100%;max-width:440px;padding:40px 36px;border:1px solid rgba(255,255,255,0.08);border-radius:20px;background:#141414">
  <div style="display:flex;align-items:center;gap:14px;margin-bottom:28px">
    ...
    <div style="line-height:1.2">
      <p style="font-size:8px;font-weight:700;letter-spacing:2.5px;text-transform:uppercase;color:#792990;margin:0">Digital</p>
      <p style="font-size:8px;font-weight:700;letter-spacing:2.5px;text-transform:uppercase;color:#792990;margin:0">Solutions</p>
    </div>
    <div style="width:1px;height:22px;background:rgba(255,255,255,0.1)"></div>
    <img src="/logo.svg" alt="Salto" style="height:20px;width:auto;display:block;opacity:0.7">
  </div>
  ...
  <div style="display:flex;flex-direction:column;gap:12px;margin-bottom:24px">
    <input id="inp-nome" type="text" placeholder="Nome do cliente" autocomplete="off"
      ...
      onfocus="this.style.borderColor='rgba(121,41,144,0.5)'" onblur="this.style.borderColor='rgba(255,255,255,0.08)'">
    ...
    <div id="logo-upload-area" onclick="document.getElementById('inp-logo').click()"
      ...
      onmouseover="this.style.borderColor='rgba(121,41,144,0.4)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.1)'">
  ...
  <button id="setup-ok" style="width:100%;padding:14px;border-radius:100px;border:none;background:linear-gradient(to right,#792990,#350450);color:#fff;font-family:inherit;font-size:13px;font-weight:700;cursor:pointer;letter-spacing:1px">
...
export default function DeckClient() {
  useEffect(() => {
    ...
    // ── Personalização ──
    const LS = { nome: 'wb_site_nome', emp: 'wb_site_empresa', logo: 'wb_site_logo' };
    ...
    if (inpLogo) {
      inpLogo.addEventListener('change', (e) => {
        ...
        reader.onload = (ev) => {
          ...
          if (lbl) { lbl.textContent = '✓ Logo carregado'; lbl.style.color = '#792990'; }
        };
    ...
    <>
      ...
      <div style={{
        ...
        <div style={{ lineHeight: 1 }}>
          ...
          <p style={{ fontSize: 7, fontWeight: 700, color: '#792990', letterSpacing: 1.5, textTransform: 'uppercase', margin: 0 }}>Digital</p>
        </div>
      </div>
      ...
      <button
        ...
        onMouseEnter={e => { (e.currentTarget as HTMLButtonElement).style.borderColor = '#792990'; (e.currentTarget as HTMLButtonElement).style.color = '#792990'; }}
