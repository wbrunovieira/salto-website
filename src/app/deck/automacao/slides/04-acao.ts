...
<div class="slide" data-s="7">
  ...
  <div class="wfull" style="max-width:780px">
    <div data-a style="margin-bottom:28px">
      <span class="badge"><span class="dot"></span>O QUE A GENTE FAZ</span>
    </div>
    <h2 data-a class="hl mb2">A gente mapeia,</h2>
    <h2 data-a class="hl hl-acc" style="margin-bottom:32px">constrói e entrega.</h2>
  ...
  <div class="wfull" style="max-width:780px">
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-bottom:20px">
      ...
      <div data-a class="card card-hot" style="padding:32px 36px;display:flex;flex-direction:column;justify-content:space-between;min-height:200px">
        <div>
          <p style="font-size:11px;font-weight:700;letter-spacing:3px;text-transform:uppercase;color:var(--accent);margin-bottom:16px">A partir de</p>
          <div style="display:flex;align-items:baseline;gap:8px;margin-bottom:8px">
            <span style="font-size:13px;color:var(--muted);font-weight:700">R$</span>
            <span style="font-size:clamp(36px,5vw,56px);font-weight:900;color:var(--text);line-height:1;letter-spacing:-2px">300</span>
            <span style="font-size:18px;color:var(--muted);font-weight:700;align-self:center">até</span>
            <span style="font-size:clamp(36px,5vw,56px);font-weight:900;color:var(--accent);line-height:1;letter-spacing:-2px">3.000</span>
          </div>
          <p style="font-size:13px;color:var(--muted);line-height:1.6">dependendo da complexidade da solução</p>
        </div>
      </div>
