          ...
          <div id="contact-left" className="lg:col-span-2 flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-3">
              ...
              <a href={`mailto:${t("email")}`}
                className="group flex items-center gap-3 p-4 rounded-xl border border-border bg-surface/30 hover:border-accent/30 transition-all duration-200">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-text-primary group-hover:text-accent transition-colors duration-200">{t("email")}</p>
                </div>
              </a>
              ...
              <a href={`tel:+551150264203`}
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-text-primary group-hover:text-accent transition-colors duration-200">{t("phoneNumber")}</p>
                </div>
              </a>
