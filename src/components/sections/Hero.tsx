...
const TYPE_SPEED = 0.095; // seconds per character
...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex flex-col overflow-hidden px-6">
      ...
      >
        ...
        <p id="hero-sub" className="max-w-xl text-lg md:text-xl text-text-muted leading-relaxed mt-14">
          {t('subheadline')}
        </p>

        <div id="hero-cta" className="flex flex-col sm:flex-row items-center gap-4 mt-12">
      ...
      <div id="hero-scroll" className="relative z-10 flex flex-col items-center gap-2 pb-8 pointer-events-none">
